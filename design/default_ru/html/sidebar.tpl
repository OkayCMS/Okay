<nav id="catalog_menu" class="block">
	<span class="block_heading">Каталог товаров</span>
...
{if $browsed_products}
<div class="block">
	<div class="block_heading">Вы просматривали</div>
...
{* Сравнение *}
<div id="comparison_anim" class="block_heading">Папка сравнения</div>
