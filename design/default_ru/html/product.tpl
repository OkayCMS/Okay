	...
	<div class="row">
		...
		<div id="product_info" class="column col_7">
			{if $product->variant->sku}
				<div class="sku">Артикул: <span>{$product->variant->sku}</span></div>
			{/if}
				...
				<div id="comments">
					...
					<ul class="comment_list">
						...
						<li>
							...
							<div class="comment_header">	
								...
								{if !$comment->approved}<strong>ожидает модерации</strong>{/if}
							</div>
					...
					<form class="form comment_form" method="post">
						...
						<div class="form_group">
							<input class="form_input" type="text" id="comment_name" name="name" value="{$comment_name}" data-format=".+" data-notice="Введите имя" placeholder="Имя"/>
						</div>
						<textarea class="comment_textarea" id="comment_text" name="text" data-format=".+" data-notice="Введите комментарий" placeholder="Введите комментарий">{$comment_text}</textarea>
...
<div id="related" class="clearfix">
	<div class="block_heading">Советуем посмотреть</div>
