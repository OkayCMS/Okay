...
<div class="pagination{if $ajax} is_ajax{/if}">
	...
	{if $current_page_num==2}<a class="prev_page_link" href="{furl page=null}">&lt; назад</a>{/if}
	{if $current_page_num>2}<a class="prev_page_link" href="{furl page=$current_page_num-1}">&lt; назад</a>{/if}
	...
	{if $current_page_num<$total_pages_num}<a class="next_page_link" href="{furl page=$current_page_num+1}">вперед &gt;</a>{/if}

	<a href="{furl page=all}">все сразу</a>
