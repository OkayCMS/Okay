    ...
    <div class="row">
        <form class="col-lg-7" action="payment/Receipt/callback.php" method="post">
    	    ...
    	    <div class="form_group">
    		    <input class="form_input" type="text" name="name" value="" placeholder="{$lang->form_name}*" required="">
    	    </div>
    	    <div class="form_group">
    		    <input class="form_input" type="text" name="address" value="" placeholder="{$lang->form_address}*" required="">
    	    </div>
