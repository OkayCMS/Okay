                                    ...
                                    <div>
                                        <div style="text-align: left; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                            ...
                                            <table border="0" cellpadding="3" cellspacing="0" style="font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5; width:100%; border-collapse: collapse">
                                                <tbody>
                                                <tr>
                                                    <td style="background-color:#38c0f3;border-bottom: 1px solid #fff;"><span style="font-size:14px;"><span style="font-family:trebuchet ms,helvetica,sans-serif;"><span style="color:#ffffff;"><strong>{$lang->email_order_status}</strong></span></span></span></td>
                                                ...
                                                <tr>
                                                    <td style="background-color:#38c0f3;border-bottom: 1px solid #38c0f3">
                                                        <span style="font-size:14px;"><span style="font-family:trebuchet ms,helvetica,sans-serif;"><span style="color:#ffffff;"><strong>{$lang->email_order_payment}</strong></span></span></span>
                                                    </td>
                        ...
                        <div>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;background: rgb(255, 255, 255)">
                                ...
                                <tr>
                                    <td border="0" valign="top" align="left" style="border: 0">
                                        <div>
                                            <div style="text-align: left; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5"><span style="font-family:trebuchet ms,helvetica,sans-serif;"><span style="font-size: 18px;">{$lang->order_details}</span></span><br />
                                                <br />
                                                <table border="0" cellpadding="3" cellspacing="0" style="font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5; width:100%; border-collapse: collapse">
                                                    <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="background-color:#38c0f3;border-bottom: 1px solid #fff;"><span style="font-size:14px;"><span style="color:#ffffff;"><strong><span style="font-family:trebuchet ms,helvetica,sans-serif;">{$lang->email_order_phone}</span></strong></span></span></td>
                                                        <td style="border: 1px solid #38c0f3;">{$order->phone|escape}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color:#38c0f3;border-bottom: 1px solid #fff;"><span style="font-size:14px;"><span style="color:#ffffff;"><strong><span style="font-family:trebuchet ms,helvetica,sans-serif;">{$lang->email_order_address}</span></strong></span></span></td>
                                                        <td style="border: 1px solid #38c0f3;">{$order->address|escape}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background-color:#38c0f3;border-bottom: 1px solid #38c0f3"><span style="font-size:14px;"><span style="color:#ffffff;"><strong><span style="font-family:trebuchet ms,helvetica,sans-serif;">{$lang->email_order_comment}</span></strong></span></span></td>
                                    ...
                                    <td style="padding-bottom: 15px;">
                                        <div>
                                            <div style="font-family: 'Trebuchet MS'; font-size: 16px; color: rgb(51, 51, 51); font-weight: normal; text-align: left; font-style: normal; line-height: normal; text-transform: none">
                                                <span style="font-family:trebuchet ms,helvetica,sans-serif;">
                                                    <span style="font-size:18px;">{$lang->email_order_purchases}</span>
                                                </span>
                                            </div>
                                        </div>
                                    </td>
                                                                ...
                                                                {if $order->paid && $purchase->variant->attachment}
                                                                    <div style="font-family:verdana,geneva,sans-serif;">
                                                                        <a href="{$config->root_url}/{$lang_link}order/{$order->url}/{$purchase->variant->attachment}">
                                                                            <em><span style="color: rgb(128, 128, 128); font-size: 11px;">{$lang->email_order_download} {$purchase->variant->attachment}</span></em>
                                                                        </a>
                                                                    </div>
                                                                {/if}
                                                            </td>
                                        ...
                                        <div>
                                            <div style="text-align: left; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                <table cellpadding="4" cellspacing="0" width="100%" style="padding: 5px;font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                    ...
                                                    {if $order->discount}
                                                        <tr>
                                                            <td style="padding-right: 10px; white-space: nowrap; text-align: right;" valign="middle">{$lang->email_order_discount}</td>
                                                            <td align="right" nowrap="nowrap" valign="middle">{$order->discount}&nbsp;%</td>
                                                        </tr>
                                                    {/if}
                                                    {if $order->coupon_discount>0}
                                                        <tr>
                                                            <td style="padding-right: 10px; white-space: nowrap; text-align: right;" valign="middle">{$lang->email_order_coupon} {$order->coupon_code}</td>
                                            ...
                                            <div style="text-align: center; font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(51, 51, 51); line-height: 1.5">
                                                <span style="font-family:trebuchet ms,helvetica,sans-serif;">
                                                    <span style="border-style: solid; border-color: rgb(234, 182, 9); background-color: rgb(234, 182, 9); border-width: 0px 0px 0px 0px; display: inline-block; border-radius: 29px">
                                                        <a href="{$config->root_url}/{$lang_link}order/{$order->url}" style="font-family: 'Trebuchet MS'; font-size: 14px; color: rgb(29, 103, 164); text-decoration: underline; border-style: solid; border-width: 8px 25px 8px 25px; display: inline-block; border-radius: 28px; border-color: rgb(242, 189, 11); background: rgb(242, 189, 11); font-size: 16px; font-family: 'Lucida Sans Unicode', 'Lucida Grande'; font-weight: bold; color: rgb(255, 255, 255); text-decoration: none">
                                                            <span style="font-family:trebuchet ms,helvetica,sans-serif;"> {$lang->email_order_info} &gt;</span>
                                                        </a>
                                                    </span>
                                                </span>
                                            </div>
