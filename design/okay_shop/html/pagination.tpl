...
{if $total_pages_num > 1}
    <ul class="pagination{if $ajax} fn_is_ajax{/if}">
        ...
        {if $current_page_num > 1}
            <li class="page_item">
                <a class="page_link" href="{if $current_page_num == 2}{url page=null}{else}{url page=$current_page_num - 1}{/if}" aria-label="{$lang->pagination_prev}">
        ...
        {if $current_page_num<$total_pages_num}
            <li class="page_item">
                <a class="page_link" href="{url page=$current_page_num+1}" aria-label="{$lang->pagination_next}">
