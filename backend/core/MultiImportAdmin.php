...
class MultiImportAdmin extends Okay {
    ...
    public function fetch() {
        ...
        if (!$this->languages->lang_id()) {
            ...
            $lang_id = $this->request->post('import_lang_id', 'integer');
            $lang_id = $lang_id ? $lang_id : $_SESSION['admin_lang_id'];
            $this->design->assign('lang_id_default', $lang_id);
        }
        ...
        return $this->design->fetch('multi_import.tpl');
    }
