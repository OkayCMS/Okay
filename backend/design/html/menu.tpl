                                        ...
                                        <div class="okay_list_row fn_sort_item">
                                            ...
                                            <div class="okay_list_boding okay_list_status">
                                                ...
                                                <label class="switch switch-default fn_switch_block" data-hint="{$btr->general_enable|escape}">
                                                    <input class="switch-input fn_ajax_action fn_visible {if $menu_item->visible}fn_active_class{/if}" data-module="menu_item" data-action="visible" data-id="{$menu_item->id}" name="visible" value="1" type="checkbox"  {if $menu_item->visible}checked=""{/if}/>
                                            ...
                                            <div class="okay_list_boding okay_list_status">
                                                ...
                                                <label class="switch switch-default hint-bottom-middle-t-info-s-small-mobile hint-anim fn_switch_block" data-hint="{$btr->menu_general_target_blank|escape}">
                                                    <input class="switch-input fn_ajax_action fn_is_target_blank {if $menu_item->is_target_blank}fn_active_class{/if}" data-module="menu_item" data-action="is_target_blank" data-id="{$menu_item->id}" name="is_target_blank" value="1" type="checkbox" {if $menu_item->is_target_blank}checked=""{/if}/>
