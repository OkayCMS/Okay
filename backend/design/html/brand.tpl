...
{if $message_error}
    ...
    <div class="message message_error">
        <span class="text">{if $message_error=='url_exists'}Бренд с таким адресом уже существует{elseif $message_error=='empty_name'}Введите название{elseif $message_error == 'empty_url'}Введите адрес{else}{$message_error}{/if}</span>
        <a class="button" href="{$smarty.get.return}">Вернуться</a>
    </div>
    <!-- Системное сообщение (The End)-->
{/if}
                ...
                <li>
                    ...
                    <div class="helper_wrap">
                        ...
                        <div class="right helper_block">
                            ...
                            <span>Активируется после сохранения бренда с заполненным полем адрес.</span>
                        </div>
                    </div>
                </li>
				<li>
                    ...
                    <input name="url" class="page_url" type="text" value="{$brand->url|escape}" />
                </li>
				<li>
