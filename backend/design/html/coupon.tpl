{* Вкладки *}
{capture name=tabs}
	{if in_array('users', $manager->permissions)}<li><a href="index.php?module=UsersAdmin">Пользователи</a></li>{/if}
    ...
    {if in_array('users', $manager->permissions)}<li><a href="index.php?module=SubscribeMailingAdmin">Подписчики</a></li>{/if}
{/capture}
