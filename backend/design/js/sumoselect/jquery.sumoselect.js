...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: 'Выберите категории',   // Dont change it here.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><label><i></i></label></p>').addClass('SlectBox').css('style', O.E.attr('style')).prepend(O.caption);
