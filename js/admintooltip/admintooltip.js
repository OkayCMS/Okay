$(function() {
	$("<a href='backend/' class='admin_bookmark'></a>").appendTo('body');
...
function show_tooltip()
{
	...
	{
		tooltipcontent = "<a href='backend/index.php?module=PageAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		tooltipcontent += "<a href='backend/index.php?module=PageAdmin&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_add>Добавить страницу</a>";
	}
		
	if(id = $(this).attr('data-category'))
	{
		tooltipcontent = "<a href='backend/index.php?module=CategoryAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		tooltipcontent += "<a href='backend/index.php?module=ProductAdmin&category_id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_add>Добавить товар</a>";
	}
	
	if(id = $(this).attr('data-brand'))
	{
		tooltipcontent = "<a href='backend/index.php?module=BrandAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
	
	if(id = $(this).attr('data-product'))
	{
		tooltipcontent = "<a href='backend/index.php?module=ProductAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
	
	if(id = $(this).attr('data-post'))
	{
		tooltipcontent = "<a href='backend/index.php?module=PostAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}

	if(id = $(this).attr('data-feature'))
	{
		tooltipcontent = "<a href='backend/index.php?module=FeatureAdmin&id="+id+"&lang_id="+lang_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
